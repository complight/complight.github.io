...
!!! Question
    If you are wondering how to get an invitation to the next seminar series, please do not hesitate to email [Kaan Akşit](mailto:k.aksit@ucl.ac.uk) or subscribe yourself to [our mailing list](http://www.mailinglists.ucl.ac.uk/mailman/list-info/high-beams-seminars) (only within University College London's network).
