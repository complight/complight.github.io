...
sudo cp -v /bin/{bash,rbash,ls,clear_console,sh,ln,which,du,ps,cp,python3,pip3,nvidia-smi,mv,vim,nano,rsync,mount,mkdir,grep,rm,cat,touch} $USERDIRECTORY/bin
