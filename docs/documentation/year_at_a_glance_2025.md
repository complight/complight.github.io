...
[**Computational Light Laboratory**](https://complightlab.com) continues its journey with the belief of groundbreaking research is powered by curiosity, collaboration, and  pursuit of excellence.
...
* [**Zicong Peng**](https://scholar.google.com/citations?user=lpi8DvIAAAAJ&hl=zh-CN)’s mastery of [deep learning-based compression for holographic displays](#assessing-learned-methods-for-hologram-compression) led to an impressive work accepted at the **SIGGRAPH 2025** track, showcasing his exceptional drive and technical ingenuity in shaping the future of immersive technologies, leading to his next as a Ph.D. student at **Koç University**,
* [**Chuanjun Zheng**](https://scholar.google.com.hk/citations?user=9Jk_LC8AAAAJ)’s remote internship bridged continents and expertise while collaborating with an external team to mentor their Ph.D. student, pioneer [a learned implicit neural representation for optical lenses](#implicit-neural-representations-for-optical-raytracing), and present their accepted work at **SIGGRAPH 2025** poster track, all before embarking on his next academic adventure at the **University of Hawaiʻi at Mānoa**.
