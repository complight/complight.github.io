...
Within 2025, Kaan also started his term as the [**Optica's Intelligent Interfaces and Display Technology (IT)**](https://www.optica.org//en-us/get_involved/technical_groups/iapd/display_technology_(it)/) group and started serving as [**ACM TOG Associate Editor**](https://dl.acm.org/journal/tog/editorial-board).
